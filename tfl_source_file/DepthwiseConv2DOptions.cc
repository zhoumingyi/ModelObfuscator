...
const int filter_dims_raw=;
const int bias_dims_size=;
const int32_t bias_dims_raw=;
TfLitePadding paddings=;
TfLiteType filter_type=;
...
TfLiteRegistration* Register_randopname_REF() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::Prepare,
...
TfLiteRegistration* Register_randopname_NEON_OPT() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::Prepare,
      randopname::Eval<randopname::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_randopname_NEON_OPT_UINT8() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::Prepare,
      randopname::EvalImpl<randopname::kNeonOptimized, kTfLiteUInt8>};
  return &r;
}

TfLiteRegistration* Register_randopname() {
#ifdef USE_NEON
  return Register_randopname_NEON_OPT();
#else
...
TfLiteRegistration* Register_randopname_UINT8() {
#ifdef USE_NEON
  return Register_randopname_NEON_OPT_UINT8();
#else
  return Register_randopname();
#endif
}
