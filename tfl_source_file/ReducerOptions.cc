...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<randopname::kReference, randopname::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_randopname_OPT() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::PrepareMeanOrSum,
                                 randopname::EvalMean<randopname::kGenericOptimized>};
  return &r;
}
...
TfLiteRegistration* Register_randopname_REF() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::PrepareMeanOrSum,
                                 randopname::EvalMean<randopname::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::PrepareMeanOrSum, randopname::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::PrepareProd, randopname::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::PrepareSimple,
      randopname::EvalGeneric<randopname::kReference, randopname::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::PrepareSimple,
      randopname::EvalGeneric<randopname::kReference, randopname::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::PrepareAllOrAny,
      randopname::EvalGeneric<randopname::kReference, randopname::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      randopname::Init, randopname::Free, randopname::PrepareAllOrAny,
      randopname::EvalGeneric<randopname::kReference, randopname::kAll>};
  return &r;
}

TfLiteRegistration* Register_randopname() {
#ifdef USE_NEON
  return Register_randopname_OPT();
#else
  return Register_randopname_REF();
#endif
}
