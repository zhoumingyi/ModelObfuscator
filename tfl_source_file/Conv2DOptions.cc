...
TfLiteRegistration* Register_randopname_REF() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::Prepare<randopname::kReference>,
                                 randopname::Eval<randopname::kReference>};
  return &r;
}

TfLiteRegistration* Register_randopname_GENERIC_OPT() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::Prepare<randopname::kGenericOptimized>,
                                 randopname::Eval<randopname::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_randopname_MULTITHREADED_OPT() {
  static TfLiteRegistration r = {randopname::Init, randopname::Free,
                                 randopname::Prepare<randopname::kMultithreadOptimized>,
                                 randopname::Eval<randopname::kMultithreadOptimized>};
  return &r;
}

// TfLiteRegistration* Register_randopname_CBLAS_OPT() {
//   static TfLiteRegistration r = {randopname::Init, randopname::Free,
//                                  randopname::Prepare<randopname::kCblasOptimized>,
//                                  randopname::Eval<randopname::kCblasOptimized>};
//   return &r;
// }

TfLiteRegistration* Register_randopname() {
#if defined TFLITE_WITH_MULTITHREADED_EIGEN
  return Register_randopname_MULTITHREADED_OPT();
#else
